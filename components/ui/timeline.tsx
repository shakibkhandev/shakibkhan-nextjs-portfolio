...
function TimelineIndicator({
  ...
  return (
    <div
      ...
      className={cn(
        `border-primary/20  absolute size-4 rounded-full border-2 group-data-[orientation=horizontal]/timeline:-top-6 group-data-[orientation=horizontal]/timeline:left-0 group-data-[orientation=horizontal]/timeline:-translate-y-1/2 group-data-[orientation=vertical]/timeline:top-0 group-data-[orientation=vertical]/timeline:-left-6 group-data-[orientation=vertical]/timeline:-translate-x-1/2 ${
          isDarkMode
            ? "group-data-completed/timeline-item:border-gray-100"
    ...
    <div
      ...
      className={cn(
        `group/timeline-item  relative flex flex-1 flex-col gap-0.5 group-data-[orientation=horizontal]/timeline:mt-8 group-data-[orientation=horizontal]/timeline:not-last:pe-8 group-data-[orientation=vertical]/timeline:ms-8 group-data-[orientation=vertical]/timeline:not-last:pb-12 ${
          isDarkMode
            ? "has-[+[data-completed]]:[&_[data-slot=timeline-separator]]:bg-gray-100"
            : "has-[+[data-completed]]:[&_[data-slot=timeline-separator]]:bg-black"
        }`,
        className
      )}
